"use client" //habilita o uso de recursos interativos no componente, necessário para Next.js com React Server Components
...
export default function Soma() {
  // Estado para armazenar o valor do primeiro número
  const [num1, setNum1] = useState('');
  const [num2, setNum2] = useState('');

  // Estado para armazenar o resultado da soma
  ...
  const handleSubmit = (e) => {
    ...
    // Converte o valor do primeiro número para um número decimal
    ...
    if (!isNaN(number1) && !isNaN(number2)) {
      ...
      setSoma('Por favor, insira números válidos'); // Exibe mensagem de erro se os valores forem inválidos
    }
  };

  return (
    // Layout básico com Tailwind CSS para centralizar o conteúdo na tela
